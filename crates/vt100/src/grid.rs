...
impl Grid {
    ...
    pub fn scrollback_contents(&self, max_lines: usize) -> Vec<String> {
        ...
        for i in start..total {
            ...
            row.write_contents(&mut contents, 0, self.size.cols, false);
            lines.push(contents);
        }
        lines
    }

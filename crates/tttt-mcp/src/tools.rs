        ...
        json!({
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "command": { "type": "string", "description": "Message to inject into the target session when the cron fires. An [ENTER] is always appended automatically to submit the message." },
                    "session_id": { "type": "string", "description": "Target session ID or name. If omitted, defaults to the first (oldest) session." },
